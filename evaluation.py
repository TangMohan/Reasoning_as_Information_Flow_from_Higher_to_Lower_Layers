...
def evaluation(checkpoint_folder, ds, result_folder, batch_size = 32, gpu_memory_limit = "35GiB"):
  ...
  multiplier = save_configs["multiplier"]
  ...
  # ds = reasoning_datasets.ParityDatasetPositionLabeled(length = 32000, seq_len = 20)
  ...
  result_file_name = f"{result_folder}/{model_name.split('/')[-1]}_improved_results.json"
...
if __name__ == "__main__":
  ...
  evaluation(checkpoint_folder, ds, result_folder, batch_size = batch_size, gpu_memory_limit = gpu_memory_limit)